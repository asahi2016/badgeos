...
function fortunato_scripts() {
	...
	global $wp_scripts;
	wp_enqueue_script( 'fortunato-html5shiv', get_template_directory_uri() . '/js/html5shiv.min.js', array(), '3.7.2', false );
	$wp_scripts->add_data( 'fortunato-html5shiv', 'conditional', 'lt IE 9' );
}
